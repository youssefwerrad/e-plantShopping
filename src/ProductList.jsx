...
function ProductList({ onHomeClick }) {
    ...
    // Calculate total quantity - updates in real-time
    ...
    return (
        <div>
            <div className="navbar">
                <a href="/" className="brand" onClick={(e) => handleHomeClick(e)}>
                    <svg className="brand-mark" viewBox="0 0 48 48" width="28" height="28" aria-hidden="true">
                        <path
                            ...
                            strokeWidth="1.6"
                        />
                        <path d="M24 4V44" fill="none" stroke="currentColor" strokeWidth="1.6" />
                    </svg>
                ...
                <nav className="nav-links">
                    ...
                    <a href="#" onClick={(e) => handleAboutUsClick(e)}>About</a>
                    <a href="#" onClick={(e) => handleAdminClick(e)}>Edit</a>
                    <a href="#" onClick={(e) => handleCartClick(e)} className="nav-cart" aria-label="View cart">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" height="26" width="26">
                    ...
                    {plantsArray.map((category, index) => (
                        <section className="category-section" key={index}>
                            <div className="category-heading">
                                ...
                                <span className="category-rule" aria-hidden="true"></span>
                            </div>
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        >
                                            {addedToCart[plant.name] ? 'In your collection' : 'Add to collection'}
